...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Applicant Accounts</h1>
    ...
    <div class="card mb-4">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Invitation for Applicant</h5>
        ...
        <script type="text/javascript">
            ...
            $('#send-invitation').on('submit', function(event){
                ...
                if(course_id === '') $('#error-ul').append('<li>Please provide a valid course</li>');
                ...
                if($('#error-ul').html() !== '') $('#error-div').show();
                    ...
                    $.ajax({
                        url: "{{ URL::to('/send-applicant-invitation') }}",
                        type: "POST",
                        headers: {
